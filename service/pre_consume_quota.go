...
func PreConsumeQuota(c *gin.Context, preConsumedQuota int, relayInfo *relaycommon.RelayInfo) *types.NewAPIError {
	...
	if userQuota <= 0 {
		return types.NewErrorWithStatusCode(fmt.Errorf("%s", i18n.Translate(i18n.GetLangFromContext(c), i18n.MsgUsageWalletExhausted)), types.ErrorCodeInsufficientUserQuota, http.StatusForbidden, types.ErrOptionWithSkipRetry(), types.ErrOptionWithNoRecordErrorLog())
	}
